...
<pin name="!CS" x="15.24" y="-12.7" length="middle" direction="in" rot="R180"/>
...
<description>2.7V 8-Channel 10 bit ADC with SPI</description>
<gates>
<gate name="G$1" symbol="MCP3004" x="0" y="0"/>
</gates>
<devices>
<device name="-I/P" package="DIL16">
<connects>
...
<part name="U2" library="simon" deviceset="MCP3008*" device="-I/SL"/>
...
<sheet>
<plain>
<text x="218.44" y="20.32" size="2.54" layer="97">B82V0.01</text>
</plain>
<instances>
...
<instance part="U2" gate="G$1" x="111.76" y="60.96" smashed="yes">
